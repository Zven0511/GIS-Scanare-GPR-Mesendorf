...
var style_Adancime_PosibilZiduriVechiGeneric_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Adancim[m]") !== null) {
        labelText = String(feature.get("Adancim[m]"));
    }
